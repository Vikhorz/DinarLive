            ...
            {loading ? (
                <div className="flex items-center gap-2">
                    <span className="relative flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full theme-live-dot opacity-75"></span>
                        <span className="theme-live-dot relative inline-flex rounded-full h-2 w-2"></span>
                    </span>
