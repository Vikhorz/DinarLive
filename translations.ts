...
const ku: Translation = {
  ...
  aboutDialogContent: "ئەپلیکەیشنێکی مۆدێرن بۆ زانینی نرخی دراوەکان. دینار ڵایڤ لە پشتەوە بە API ـیەکی سێرڤەر-ساید کاردەکات بۆ کۆکردنەوەی نرخی بازاڕ لە سەرچاوە گشتییە باوەڕپێکراوەکان و هاوکات نرخی فەرمی بانکی ناوەندی عێراق پیشان دەدات.",
  ...
  homeNavLabel: "دراو و کانزاکان",
  calculatorNavLabel: "ژمێرەر",
  chartNavLabel: "گراف",
  calculatorPageDescription: "نرخی ڕاستەوخۆ بەکاربهێنە بۆ گۆڕینی دراوەکان.",
  chartPageDescription: "گۆڕانی نرخی دینار لە حەوت ڕۆژی ڕابردوو ببینە.",
  tickerUsdAmount: "سەد دۆلار",
  tickerEuroAmount: "سەد یۆرۆ",
  tickerPoundAmount: "سەد پاوەند",
  tickerLiraAmount: "سەد لیرە",
  tickerTomanAmount: "سەد تمەن",
...
const en: Translation = {
  ...
  aboutDialogContent: "A modern, real-time currency exchange tracker. DinarLive now uses a server-side API to collect market prices from trusted public sources alongside the official Central Bank of Iraq rate.",
  ...
  homeNavLabel: "Currency & Metals",
  calculatorNavLabel: "Calculator",
  chartNavLabel: "Chart",
  calculatorPageDescription: "Convert currencies using the latest live market rates.",
  chartPageDescription: "See how the dinar rate changed over the last seven days.",
  tickerUsdAmount: "One hundred US dollars",
  tickerEuroAmount: "One hundred euros",
  tickerPoundAmount: "One hundred pounds",
  tickerLiraAmount: "One hundred lira",
  tickerTomanAmount: "One hundred tomans",
...
const ar: Translation = {
  ...
  aboutDialogContent: "تطبيق حديث لمتابعة أسعار العملات. يستخدم DinarLive الآن واجهة API خلفية لجمع أسعار السوق من مصادر عامة موثوقة إلى جانب السعر الرسمي للبنك المركزي العراقي.",
  ...
  homeNavLabel: "العملات والمعادن",
  calculatorNavLabel: "الحاسبة",
  chartNavLabel: "الرسم البياني",
  calculatorPageDescription: "حوّل العملات باستخدام أحدث أسعار السوق المباشرة.",
  chartPageDescription: "شاهد تغير سعر الدينار خلال الأيام السبعة الماضية.",
  tickerUsdAmount: "مئة دولار",
  tickerEuroAmount: "مئة يورو",
  tickerPoundAmount: "مئة جنيه إسترليني",
  tickerLiraAmount: "مئة ليرة",
  tickerTomanAmount: "مئة تومان",
